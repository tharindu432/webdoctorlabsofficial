    ...
    <div style={{
     ...
     <style jsx>{`
      ...
      <section className="relative h-[100vh] flex items-center justify-center overflow-hidden">
        <div className="relative z-10 px-4 container mx-auto max-w-3xl flex flex-col items-center justify-center text-center">
          <h2 className={`text-4xl font-bold mb-6 text-glow ${isLoaded ? 'animate-fade-in-up stagger-1' : ''}`}
              style={{ color: "#00FF85", fontFamily: "IBM Plex Serif, serif", opacity: 0 }}>
            About Web Doctor Labs
          </h2>
          <p className={`text-lg mb-8 ${isLoaded ? 'animate-fade-in-left stagger-2' : ''}`}
             style={{ color: "#FFFFFF", fontFamily: "Inter, sans-serif", opacity: 0 }}>
            Web Doctor Labs is a team of passionate engineers, designers, and strategists dedicated to building the future of digital solutions. <br /><br />
            Since our founding, we've empowered startups, enterprises, and organizations globally with custom software, AI, and cloud technologies. Our mission: deliver innovation, reliability, and measurable value.
          </p>
          <div className={`flex flex-wrap gap-4 justify-center ${isLoaded ? 'animate-scale-in stagger-3' : ''}`} style={{ opacity: 0 }}>
            <a href="/careers"
