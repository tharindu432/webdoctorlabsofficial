...
const posts = [
  {
    ...
    date: "May 2025",
    desc: "Explore real-world use cases for artificial intelligence in enterprise software.",
    link: "#"
  },
  {
    title: "Cloud Migration: A Step-by-Step Guide",
    date: "April 2025",
    desc: "Best practices and common pitfalls when moving your business to the cloud.",
    link: "#"
  },
  {
    title: "The Future of Web Development",
    date: "March 2025",
    desc: "Emerging trends in web technologies and frameworks for 2025.",
    link: "#"
  }
];
      ...
      <section className="relative min-h-[100vh] flex flex-col items-center justify-center py-24 px-4">
        <div className="relative z-10 container mx-auto max-w-4xl text-center">
          ...
          <p className={`text-lg mb-12 ${isLoaded ? 'animate-fade-in-left stagger-2' : ''}`}
            ...
            Insights, guides, and stories from our team of digital innovators.
          </p>
          <div className="grid md:grid-cols-2 gap-10">
            {posts.map((post, i) => (
              <a key={i} href={post.link}
                ...
                <h3 className="text-xl font-semibold mb-2" style={{ color: "#00FF85" }}>{post.title}</h3>
                <div className="text-xs mb-2" style={{ color: "#1E90FF" }}>{post.date}</div>
                <p className="text-base mb-2" style={{ color: "#FFFFFF" }}>{post.desc}</p>
